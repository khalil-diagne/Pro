...
if (isset($_POST['titre'])) { $val_titre = $_POST['titre']; }

$val_desc = $article['description_courte'];
if (isset($_POST['description_courte'])) { $val_desc = $_POST['description_courte']; }

$val_cont = $article['contenu'];
if (isset($_POST['contenu'])) { $val_cont = $_POST['contenu']; }

$val_cat = $article['id_categorie'];
if (isset($_POST['id_categorie'])) { $val_cat = $_POST['id_categorie']; }
?>
    ...
    <form method="post" id="formModifArt" action="modifier.php?id=<?php echo $id_article; ?>" style="display:flex; flex-direction:column; gap:1.5rem; background:var(--paper-dark); padding:2.5rem; border-radius:4px; box-shadow: 0 4px 15px rgba(0,0,0,0.03);">
        ...
        <div style="display:flex; flex-direction:column; gap:.5rem;">
            ...
            <select name="id_categorie" id="id_categorie" required
                ...
                ?>
                    <option value="<?php echo $cat['id']; ?>" <?php if ($val_cat == $cat['id']) echo 'selected'; ?>>
        ...
        <div style="display:flex; gap:10px; margin-top:10px;">
            ...
            <a href="<?php echo BASE_URL; ?>accueil.php" class="btn-page" style="justify-content:center; text-align:center; padding: 12px; border-color:var(--ink-faint); color:var(--ink-faint);">
                Annuler
            </a>
        </div>
    </form>
