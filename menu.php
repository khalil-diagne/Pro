...
<header class="masthead">
    ...
    <nav class="cat-nav">
        ...
        ?>
        <a href="<?php echo BASE_URL; ?>accueil.php" class="<?php echo $classeToutes; ?>">
            Toutes
        </a>
        ...
        ?>
            <a href="<?php echo BASE_URL; ?>accueil.php?categorie=<?php echo $cat['id']; ?>" class="<?php echo $classeActive; ?>">
